...
%fweek: format the first week of the term--it doesn't advance the date
...
\newcommand{\fweek}[3]{\wk & \mydate\today &  #1 & #2 & #3 \\}
\newcommand{\nweek}[3]{\wk & \AdvanceDate[7] \mydate\today &  #1 & #2 & #3 \\}
...
% Set this to a message about an exam day--I don't have a way to automatically include the exam date that would survive
% rearranging the schedule.
\newcommand{\examday}{\textbf{Exam Day}}
\begin{document}
\begin{flushleft}
...
% Week one
\fweek{1.1}{Sets of Real Numbers and the Cartesian Coordinate Plane}{}
\mweek{1.2}{Relations}{}
