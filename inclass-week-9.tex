...
\begin{parts}
    ...
    \part [2] Use algebra tools to find an equivalent inequality of the 
    ...
    \part[2] Find all x-intercepts and all VAs for $\frac{P(x)}{Q(x)}$.
    ...
    \part [2] Put all x-intercepts and VAs on to a number line.
    ...
    \vfill 
    \newpage
    \part [2] Build the chart with columns for the interval, the test
    ...
    \part [2] Test each interval endpoint for inclusion or
    ...
    \part [2] Express the solution set in either interval notation, 
