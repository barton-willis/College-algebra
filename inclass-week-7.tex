...
\end{tikzpicture}
    ...
    \begin{solution}[4.0in]
      ...
      \begin{tabular}{|c|c|c|c|} \hline \hline 
        \textbf{Interval} &  $\mathbf{x}$  & $\mathbf{x^2 -x = 12}$  & \textbf{true/false}\\ \hline 
        $((-\inf,-3)$  & -4 &  $(-4)^2 + 4 \leq 12 $ & true \\  \hline 
        $((-3,4)$  & 0 &  $(0)^2 + 0 \leq 12 $  &false \\ \hline 
        $((4, \inf)$  & 5 &  $(5)^2 + 4 \leq 12 $ & true  \\ \hline        
      \end{tabular}
