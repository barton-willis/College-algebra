...
\newcommand{\nweek}[3]{\wk &  \AdvanceDate[2] \mydate\today  &  #1 & #2 & #3 \AdvanceDate[2] \\}
\newcommand{\eweek}[3]{ &  & #1 & #2 & #3 \AdvanceDate[5] \\ \hline}
...
% Week one
\nweek{1.1---1.2}{Sets of Real Numbers and the Cartesian Coordinate Plane}{}
%\mweek{1.2}{Relations}{}
\eweek{1.3}{Introduction to Functions}{\hw}
% Week 2
\nweek{1.4---1.5}{Function Notation}{}
